    ...
    <footer class="cs_footer cs_style_2 cs_accent_bg cs_white_color">
        <div class="cs_newsletter_2_wrap">
          <div class="container">
            <div class="cs_newsletter cs_style_2">
              <div class="cs_newsletter_img"><img src="/img/home_3/newsletter_img.png" alt=""></div>
              <div class="cs_newsletter_in">
                <p class="cs_newsletter_subtitle cs_accent_color m-0 text-uppercase cs_fs_24">Devenez nos abonnés</p>
                <div class="cs_height_6"></div>
                <h2 class="cs_newsletter_title cs_fs_72">Pour obtenir les dernières nouvelles sur la santé de nos experts</h2>
                <form action="#" class="cs_newsletter_form">
                  ...
                  <button class="cs_btn cs_style_1">
                    <span>Submit</span>
                    <i>
                      <img src="/img/home_3/icons/arrow_white.svg" alt="Icon">
                      <img src="/img/home_3/icons/arrow_white.svg" alt="Icon">
                    </i>
                  </button>
                </form>
            ...
            <div class="cs_footer_col">
              <div class="cs_footer_item">
                <div class="cs_text_widget">
                  <img src="/img/footer_logo_white.svg" alt="Logo">
                  <p class="cs_medium">Centre médical et de soins de santé alpapie medic</p>
                </div>
        ...
        <div class="cs_footer_bottom">
          <div class="container">
            <div class="cs_copyright">Copyright © 2024 Alpapie medic. Tous droits réservés.</div>
          </div>
        </div>
      </footer>
      <!-- End Footer Section -->
